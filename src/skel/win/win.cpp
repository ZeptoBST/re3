				...
				switch ( gGameState )
				{
					...
					case GS_LOGO_MPEG:
					{
						...
						if ( startupDeactivate || ControlsManager.GetJoyButtonJustDown() != 0 )
							++gGameState;
						else if ( CPad::GetPad(0)->NewState.CheckForInput() )	// ZAdd: Allows skipping intro movies with controller. #Skip intro with controller
							++gGameState;	// ZAdd: #Skip intro with controller
